...
Mani: Update of UML diagram, design notes on Clean architecture/SOLID, implementation of Payment method (entity + use case + presenter + gateway) and Flight + FlightTracker + Seat + Seatmap entities, Implementation of all connector (gateway) classes, Database repackaging, Singleton Design pattern implementation for FlightTracker, User/Customer functionality refactoring
